...
UsbDeepCheckWidget::UsbDeepCheckWidget(QWidget* parent)
...
void UsbDeepCheckWidget::initUI()
{
...
void UsbDeepCheckWidget::initConnect()
{
    ...
    connect(pathBrowserBtn, &StaticButton::buttonClicked, this, &UsbDeepCheckWidget::setFolderPath);

    connect(docCheck, &QCheckBox::stateChanged, this, &UsbDeepCheckWidget::setFileType);
    connect(xlsCheck, &QCheckBox::stateChanged, this, &UsbDeepCheckWidget::setFileType);
    connect(pptCheck, &QCheckBox::stateChanged, this, &UsbDeepCheckWidget::setFileType);
    connect(pdfCheck, &QCheckBox::stateChanged, this, &UsbDeepCheckWidget::setFileType);
    connect(wpsCheck, &QCheckBox::stateChanged, this, &UsbDeepCheckWidget::setFileType);
    connect(zipCheck, &QCheckBox::stateChanged, this, &UsbDeepCheckWidget::setFileType);
...
void UsbDeepCheckWidget::setFolderPath()
{
...
void UsbDeepCheckWidget::setFileType()
{
    QString types;
...
void UsbDeepCheckWidget::startCheck()
{
...
void UsbDeepCheckWidget::cancelCheck()
{
    startcheckbtn->show();
    cancelcheckbtn->hide();
    progressbar_background->hide();
...
void UsbDeepCheckWidget::updateCheckingElapsedTime()
{
...
void UsbDeepCheckWidget::completerateUpdate(const int completerate, const QString& status)
{
...
void UsbDeepCheckWidget::dataCountUpdate(const int totalproblems, const int totalinfomations)
{
    QString qs;
    if (totalproblems > 0)
