#include "netrecorddeepcheckwidget.h"
...
NetRecordDeepCheckWidget::NetRecordDeepCheckWidget(QWidget* parent)
...
void NetRecordDeepCheckWidget::initUI()
{
...
void NetRecordDeepCheckWidget::initConnect()
{
    ...
    connect(pathBrowserBtn, &StaticButton::buttonClicked, this, &NetRecordDeepCheckWidget::setFolderPath);

    connect(docCheck, &QCheckBox::stateChanged, this, &NetRecordDeepCheckWidget::setFileType);
    connect(xlsCheck, &QCheckBox::stateChanged, this, &NetRecordDeepCheckWidget::setFileType);
    connect(pptCheck, &QCheckBox::stateChanged, this, &NetRecordDeepCheckWidget::setFileType);
    connect(pdfCheck, &QCheckBox::stateChanged, this, &NetRecordDeepCheckWidget::setFileType);
    connect(wpsCheck, &QCheckBox::stateChanged, this, &NetRecordDeepCheckWidget::setFileType);
    connect(zipCheck, &QCheckBox::stateChanged, this, &NetRecordDeepCheckWidget::setFileType);
...
void NetRecordDeepCheckWidget::setFolderPath()
{
...
void NetRecordDeepCheckWidget::setFileType()
{
    QString types;
...
void NetRecordDeepCheckWidget::startCheck()
{
...
void NetRecordDeepCheckWidget::cancelCheck()
{
    startcheckbtn->show();
    cancelcheckbtn->hide();
    progressbar_background->hide();
...
void NetRecordDeepCheckWidget::updateCheckingElapsedTime()
{
...
void NetRecordDeepCheckWidget::completerateUpdate(const int completerate, const QString& status)
{
...
void NetRecordDeepCheckWidget::dataCountUpdate(const int totalproblems, const int totalinfomations)
{
    QString qs;
    if (totalproblems > 0)
