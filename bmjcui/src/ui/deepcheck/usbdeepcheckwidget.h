#ifndef USBDEEPCHECKWIDGET_H
#define USBDEEPCHECKWIDGET_H
...
class UsbDeepCheckWidget : public BaseStyleWidget {
    Q_OBJECT

public:
    explicit UsbDeepCheckWidget(QWidget* parent = 0);
    ~UsbDeepCheckWidget();
