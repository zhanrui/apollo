...
UsbRecordDeepRpt::~UsbRecordDeepRpt()
{
}

UsbRecordDeepRpt::UsbRecordDeepRpt(QWidget* parent, const QString& title)
...
void UsbRecordDeepRpt::initUI(const QString& titletext)
{
...
void UsbRecordDeepRpt::initModel()
{
...
void UsbRecordDeepRpt::initViewDetail(QTableView* view)
{
...
void UsbRecordDeepRpt::addUsbRecordsInfo(const QVariantList& result)
{
